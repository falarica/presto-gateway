        ...
        implements SystemAccessControl
{
    ...
    private FileBasedSystemAccessControl(
            ...
            List<ClusterAccessControlRule> clusterRules,
            ...
            implements SystemAccessControlFactory
    {
        ...
        private SystemAccessControl create(String configFileName)
        {
            ...
            ImmutableList.Builder<ClusterAccessControlRule> clusterRulesBuilder = ImmutableList.builder();
            clusterRulesBuilder.addAll(rules.getClusterRules());
            ...
            clusterRulesBuilder.add(new ClusterAccessControlRule(
                    ClusterAccessControlRule.AccessMode.ALL,
                    Optional.of(Pattern.compile(".*")),
                    Optional.empty(),
                    Optional.of(Pattern.compile("system"))));
